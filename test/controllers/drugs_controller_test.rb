...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { addicted: @drug.addicted, drug_type: @drug.drug_type, drugs_period: @drug.drugs_period, previous_treatment: @drug.previous_treatment }
    end
  ...
  test "should update drug" do
    patch :update, id: @drug, drug: { addicted: @drug.addicted, drug_type: @drug.drug_type, drugs_period: @drug.drugs_period, previous_treatment: @drug.previous_treatment }
    assert_redirected_to drug_path(assigns(:drug))
  end
