...
class YearsControllerTest < ActionController::TestCase
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post :create, year: { addicted: @year.addicted, alcohol: @year.alcohol, drinking: @year.drinking, period: @year.period, previous: @year.previous, treatment: @year.treatment, type: @year.type }
    end
  ...
  test "should update year" do
    patch :update, id: @year, year: { addicted: @year.addicted, alcohol: @year.alcohol, drinking: @year.drinking, period: @year.period, previous: @year.previous, treatment: @year.treatment, type: @year.type }
    assert_redirected_to year_path(assigns(:year))
  end
