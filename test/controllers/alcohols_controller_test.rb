...
class AlcoholsControllerTest < ActionController::TestCase
  ...
  test "should create alcohol" do
    assert_difference('Alcohol.count') do
      post :create, alcohol: { addicted: @alcohol.addicted, drinking_period: @alcohol.drinking_period, previous_treatment: @alcohol.previous_treatment, type: @alcohol.type }
    end
  ...
  test "should update alcohol" do
    patch :update, id: @alcohol, alcohol: { addicted: @alcohol.addicted, drinking_period: @alcohol.drinking_period, previous_treatment: @alcohol.previous_treatment, type: @alcohol.type }
    assert_redirected_to alcohol_path(assigns(:alcohol))
  end
